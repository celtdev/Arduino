...
#define KOL_LED       32         // Сколько светодиодов в гирлянде при первом включении
...
#define IR_MAX_LEDS   32         // Максимальное количество светодиодов при работе с пультом должно быть больше
// или равно KOL_LED
