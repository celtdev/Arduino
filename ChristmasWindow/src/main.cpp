...
// ******************** ЭФФЕКТЫ И РЕЖИМЫ ********************
#define D_TEXT_SPEED 20      // скорость бегущего текста по умолчанию (мс)
#define D_EFFECT_SPEED 250     // скорость эффектов по умолчанию (мс)
...
int AUTOPLAY_PERIOD = 360;     // время между авто сменой режимов (секунды)
