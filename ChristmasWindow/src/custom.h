...
#define MODES_AMOUNT 15   // количество кастомных режимов (которые переключаются сами или кнопкой)
...
void customModes() {
  switch (thisMode) {
    ...
    case 8: snowRoutine();
      break;
    case 9: sparklesRoutine();
      break;
    case 10: matrixRoutine();
      break;
    case 11: starfallRoutine();
      break;
    case 12: ballRoutine();
      break;
    case 13: ballsRoutine();
      break;
    case 14: fireRoutine();
      break;
  }
